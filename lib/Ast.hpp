...
case AstType::AssignExpr: return visitAssignExpr(static_cast<Assign*>(ast));
case AstType::BinaryExpr: return visitBinaryExpr(static_cast<Binary*>(ast));
...
case AstType::GroupingExpr: return visitGroupingExpr(static_cast<Grouping*>(ast));
case AstType::LiteralExpr: return visitLiteralExpr(static_cast<Literal*>(ast));
case AstType::LogicalExpr: return visitLogicalExpr(static_cast<Logical*>(ast));
...
case AstType::VariableExpr: return visitVariableExpr(static_cast<Variable*>(ast));
...
case AstType::ExpressionStmt: return visitExpressionStmt(static_cast<Expression*>(ast));
case AstType::FunctionStmt: return visitFunctionStmt(static_cast<Function*>(ast));
...
case AstType::ReturnStmt: return visitReturnStmt(static_cast<Return*>(ast));
